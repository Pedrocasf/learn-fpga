  // Default femtosoc configuration file for IceSugar
...
//`define NRV_IO_MAPPED_SPI_FLASH// SPI flash mapped in address space. Can be used with MINIRV32 to run code from SPI flash.
 // SPI flash mapped in address space. Can be used with MINIRV32 to run code from SPI flash.
...
//`define NRV_FEMTORV32_PETITBATEAU   // RV32IMFC + IRQ, does not fit on IceSugar

`define NRV_FREQ 16                 // Frequency in MHz. Recomm: 16 MHz   Overclocking: 20-25 MHz
`define NRV_RESET_ADDR 32'h00000000 // Jump execution to SPI Flash (800000h, +1024k(100000h) for FPGA bitstream)
