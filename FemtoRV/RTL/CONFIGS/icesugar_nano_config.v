...
//`define NRV_IO_IRDA          // In IO_LEDS, support for the IRDA on the IceSugar nano (WIP)
...
`define NRV_FREQ 60                 // Validated at 36 MHz on the IceSugar nano. Can overclock to 72 MHz.
...
`define NRV_FREQ 36                 // Validated at 36 MHz on the IceSugar nano. Cannot overclock.
`define NRV_RESET_ADDR 32'h00000000 // Jump execution to SPI Flash (800000h, +64k(10000h) for FPGA bitstream)
`define NRV_COUNTER_WIDTH 1         // Number of bits in cycles counter
//`define NRV_TWOLEVEL_SHIFTER      // Faster shifts
